...
Акценты лучше всего использовать с вопросительными предложениями.
Чтобы выделить акцент, можно использовать тег `<[accented]>` или выделить слово при помощи ``**accented**``. Например:

```text
Но что это за <[accented]> записи, о которых ты говоришь, Вася?
```
...
Фонетическое произношение можно использовать вместе с акцентированием

```text
Но что это за <[accented]> записи, о которых ты говоришь, [[v a sʲ ʌ]]?
```
